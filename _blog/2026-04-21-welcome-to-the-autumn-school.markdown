...
fa-link:
categories: [example]
description: "This 3-day event focuses on mixed quantum-classical molecular dynamics using CP2K, Newton-X and WaveMixings on High-Performance
Computing (HPC) cluster systems.
