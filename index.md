---
layout: workshop
venue: "Christian-Albrechts-University of Kiel"   # brief name of host site without address (e.g., "Euphoric State University")
address: "Wissenschaftszentrum Kiel, Fraunhoferstrasse 13, 24118 Kiel"     # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
humandate: "October 14-16, 2026"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
email: ["hehn@pctc.uni-kiel.de"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
...
# International Autumn School on mixed quantum-classical molecular dynamics

## About the Autumn School 

The school aims to provide training for the following program packages
- CP2K ()
- Newton-X ()
- WaveMixings ()
